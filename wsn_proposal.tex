...
Preetha Ram, which is involved in the ``mechanicalmooc'' has been quoted to say: ``We want to do more than sign up tens of thousands of students and have only a fraction succeed. Our goal is to have everyeone who participates succeed''.
...
\begin{marginfigure}
\includegraphics[width=0.5\linewidth]{Tiberius}
...
\begin{marginfigure}
\includegraphics[width=0.5\linewidth]{Albert}
