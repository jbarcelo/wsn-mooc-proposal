...
Laia Albo -To Be Confirmed, Someone from P2PF -TBC, Tiberius Brastaviceanu, Someone from FabLab -TBC
...
\item Someone from MID -TBC (Media Interaction Design Lab)
\end{itemize}
\end{itemize}
